...
df = pd. read_csv(r'C:\Users\HP\OneDrive\Desktop\AiMl\2.Projects\1.ML\4.DiabetesPredictionweb\DiabetesPredictionMLStreamlit\diabetes.csv')
...
def user_report():
    ...
    # this is because program requires the labels in same case as given to it during the test phase 
